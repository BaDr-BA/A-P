...
def generate_gemini_content_direct(prompt_text, enable_search=False):
    ...
    # هنا التعديل: ضفنا تحذير صريح من العناوين ومسودة التفكير
    system_instruction = """
    تعليمات صارمة للنشر (الأولوية القصوى):
    1. اكتب النص المطلوب مباشرة للنشر باللغة العربية فقط.
    ...
    4. تحذير حاسم: ممنوع نهائياً كتابة خطوات تفكيرك، أو مسودة العمل، أو أي كلمات باللغة الإنجليزية (مثل: Topic, Draft, Constraints, Narrative).
    5. أريد النتيجة النهائية الصافية الجاهزة للنشر فقط لا غير.
    """
